...
import { AsyncPrecondition } from '@quenk/precondition/lib/async';
...
/**
 * UserCheckContext contains values and checks that can be used at the field level.
 */
export interface UserCheckContext {
}


/**
* UserCheckProvider for the User type.
 */
export type UserCheckProvider
  = (ctx: UserCheckContext) => _prec.AsyncPrecondition<_json.Value, User>
  ;

/**
 * fieldChecks for User (AUTOGENERATED).
 */ 
export const fieldChecks = (_:UserCheckContext) : 
 ...
 */ 
export const partialFieldChecks = (_: UserCheckContext):
  _prec.Preconditions<_json.Value, _json.Value> =>({
 ...
 * (AUTOGENERATED).
 */
 export const check:UserCheckProvider  = (_: UserCheckContext) :
 _prec.Precondition<_json.Value, User> => {
 //@ts-ignore: 6133 
 let {  } = _;
    return _prec.and<_json.Value, User,User>(
 ...
 * (AUTOGENERATED).
 */
 export const checkPartial:UserCheckProvider = (_: UserCheckContext) :
 _prec.Precondition<_json.Value, Partial<User>> => {
 //@ts-ignore: 6133 
 let {  } = _;
    return _prec.and<_json.Value, User,User>(_prec.async<_json.Value,User>(validatePartial), 
